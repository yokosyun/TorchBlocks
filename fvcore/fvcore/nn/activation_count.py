...
def zero_activation(i: Any, outputs: List[Any]) -> int:
    return 0
...
_DEFAULT_SUPPORTED_OPS: Dict[str, Handle] = {
    ...
    "aten::add": generic_activation_jit(),
    "aten::div": generic_activation_jit(),
    "aten::layer_norm": generic_activation_jit(),
    # "aten::unflatten": generic_activation_jit(),
    "aten::sigmoid": generic_activation_jit(),
    "aten::clone": generic_activation_jit(),
    "aten::zero_": generic_activation_jit(),
    "aten::exp": generic_activation_jit(),
    "aten::linalg_vector_norm": generic_activation_jit(),
    "aten::clamp_min": generic_activation_jit(),
    "aten::batch_norm": generic_activation_jit(),
    "aten::silu_": generic_activation_jit(),
    "aten::add_": generic_activation_jit(),
    "aten::rsub": generic_activation_jit(),
    "aten::scaled_dot_product_attention": generic_activation_jit(),
    "aten::gelu": generic_activation_jit(),
    "aten::pad": zero_activation,
    "aten::numel": zero_activation,
    "aten::expand_as": zero_activation,
    "aten::unflatten": zero_activation,
    "aten::pad": zero_activation,
    "aten::pad": zero_activation,
    "aten::adaptive_avg_pool2d": generic_activation_jit(),
    # "aten::gelu": generic_activation_jit(),
}
