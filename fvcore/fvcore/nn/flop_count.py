...
_DEFAULT_SUPPORTED_OPS: Dict[str, Handle] = {
    ...
    "aten::ne": elementwise_flop_counter(1, 0),
    "aten::sigmoid": elementwise_flop_counter(1, 0),  # TODO!
    "aten::rsub": elementwise_flop_counter(1, 0),
    "aten::zero_": elementwise_flop_counter(1, 0),
    "aten::clone": elementwise_flop_counter(1, 0),
    "aten::clamp_min": elementwise_flop_counter(1, 0),
    "aten::exp": elementwise_flop_counter(1, 0),  # TODO!
    "aten::numel": zero_flop_jit,  # TODO!
    "aten::silu": elementwise_flop_counter(1, 0),  # TODO!
    "aten::silu_": elementwise_flop_counter(1, 0),  # TODO!
    "aten::gelu": elementwise_flop_counter(1, 0),  # TODO!
    "aten::fill_": elementwise_flop_counter(1, 0),
    "aten::sub": elementwise_flop_counter(1, 0),
    "aten::softmax": elementwise_flop_counter(1, 0),  # TODO!
    "aten::linalg_vector_norm": elementwise_flop_counter(1, 0),  # TODO!
    "aten::pad": elementwise_flop_counter(1, 0),  # TODO!
    "aten::expand_as": elementwise_flop_counter(1, 0),  # TODO!
    "aten::scaled_dot_product_attention": scaled_dot_product_attention_flop_jit,
    "aten::unflatten": zero_flop_jit,
}
